...
export const metadata: Metadata = {
  title: "Contact Us â€” Cyber A1 Academy",
  description:
...
export default function ContactPage() {
  ...
  const hours = settings?.hours ?? "Monâ€“Sat: 9:30 AM â€“ 7:00 PM";
  ...
  const offices = [
    ...
    { city: "Delhi", address: "Delhi Office â€” Contact for exact address", isPrimary: false },
    { city: "Kolkata", address: "Kolkata Office â€” Contact for exact address", isPrimary: false },
  ];
  return (
    <div className="pt-16">
      {/* Hero */}
